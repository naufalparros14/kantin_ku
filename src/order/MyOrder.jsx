  ...
  render() {
    return (
      <div className="wrapper order">
        <h2 className="h3 mb-2">Pesanan</h2>
        <div className="card p-3 mb-4">
          <p className="name">Freeze</p>
          <p className="saldo">Rp. 111.222.333,-</p>
          <p className="card-number mb-0">140****091</p>
        </div>

        <div className="calculate p-3 scroll">
          {
        ...
        <div className="wrapper-btn p-3 w-100">
          <button className="btn w-100">Beli</button>
        </div>
      </div>
    )
  }
